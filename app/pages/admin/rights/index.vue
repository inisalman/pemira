...
<style scoped>
.admin-rights { display:grid; gap:var(--space-6); }.page-header { display:flex; justify-content:space-between; align-items:end; gap:var(--space-6); flex-wrap:wrap; }.eyebrow { margin:0 0 var(--space-2); color:var(--color-primary); font-size:.75rem; font-weight:700; letter-spacing:.08em; }.page-header h1 { margin-bottom:var(--space-2); }.intro,.actions p,.readiness p,.table-heading span { margin:0; color:var(--color-text-muted); }.period-select { display:grid; gap:var(--space-1); font-size:var(--text-sm); font-weight:600; }.period-select select { min-width:18rem; min-height:2.75rem; padding:var(--space-2) var(--space-3); border:1px solid var(--color-border-strong); border-radius:var(--radius); background:var(--color-surface); color:var(--color-text); font:inherit; }.actions,.readiness { display:flex; align-items:center; justify-content:space-between; gap:var(--space-6); padding:var(--card-padding); border:1px solid var(--color-border); border-radius:var(--radius-xl); background:var(--color-surface); box-shadow:var(--shadow-sm); }.action-group { display:flex; align-items:center; gap:var(--space-3); flex-wrap:wrap; }.actions h2,.readiness h2,.table-heading h2 { margin:0 0 var(--space-1); font-size:var(--text-lg); }.readiness.ready { border-color:var(--color-success); background:var(--color-success-bg); box-shadow:none; }.readiness.not-ready { border-color:var(--color-warning); background:var(--color-warning-bg); align-items:start; box-shadow:none; }.readiness ul { margin:var(--space-3) 0 0; padding-left:var(--space-6); }.table-heading { display:flex; align-items:baseline; gap:var(--space-3); }.table-wrap { overflow-x:auto; border:1px solid var(--color-border); border-radius:var(--radius-lg); background:var(--color-surface); box-shadow:var(--shadow-sm); }.table-wrap table { width:100%; border-collapse:collapse; font-size:var(--text-sm); }.table-wrap th,.table-wrap td { padding:var(--space-3); border-bottom:1px solid var(--color-border); text-align:start; }.table-wrap thead th { background:var(--color-surface-muted); }.table-wrap tbody th { font-weight:600; }.state { padding:var(--space-8) var(--space-4); text-align:center; color:var(--color-text-muted); background:var(--color-surface); border:1px dashed var(--color-border-strong); border-radius:var(--radius-lg); }
